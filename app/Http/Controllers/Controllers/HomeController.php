...
class HomeController extends Controller
{
    ...
    {
        $collections = [
            ['name' => 'Senator', 'slug' => 'senator', 'bg' => '#c8d5e0'],
            ['name' => 'Kaftan', 'slug' => 'kaftan', 'bg' => '#e8e0d5'],
            ['name' => 'Suit', 'slug' => 'suit', 'bg' => '#d5c8b0'],
            ['name' => 'Native Wears', 'slug' => 'native', 'bg' => '#c8b89a'],
            ['name' => 'Agbada', 'slug' => 'agbada', 'bg' => '#f0ebe0'],
        ];
